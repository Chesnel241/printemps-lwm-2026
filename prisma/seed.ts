...
async function main() {
  ...
  for (const p of PARTS) {
    const isAdmin = ADMIN_NAMES.includes(p.nom);
  ...
  // Clear existing announcements to avoid duplicates on re-seed
  await prisma.announcement.deleteMany({});

  await prisma.announcement.create({
    data: {
      titleFr: 'Bienvenue à la Retraite de Printemps 2026 !',
      titleEn: 'Welcome to the Spring Retreat 2026!',
      titleKo: '2026년 봄 수련회에 오신 것을 환영합니다!',
      titleZh: '欢迎参加 2026 年春季灵修会！',
      bodyFr: 'Nous sommes heureux de vous accueillir au Centre des Pères Lazaristes de Villebon-sur-Yvette.\n\nQue ces 3 jours (4–6 avril) soient un temps de grâce, de ressourcement et de renouvellement spirituel pour chacun d\'entre vous.\n\nQue Dieu soit au centre de chaque moment ! 🙏',
      bodyEn: 'We are happy to welcome you to the Centre des Pères Lazaristes in Villebon-sur-Yvette.\n\nMay these 3 days (April 4–6) be a time of grace, healing, and spiritual renewal for each of you.\n\nMay God be at the center of every moment! 🙏',
      bodyKo: '빌봉 쉬르 이베트의 라자르 신부님 센터에 오신 것을 환영합니다.\n\n이번 3일(4월 4일~6일)이 여러분 각자에게 은혜와 회복, 영적 갱신의 시간이 되기를 바랍니다.\n\n모든 순간의 중심에 하나님이 계시기를 기도합니다! 🙏',
      bodyZh: '我们很高兴欢迎您来到维勒邦叙尔伊韦特的拉扎里斯特神父中心。\n\n愿这 3 天（4 月 4 日至 6 日）成为你们每个人恩典、休息和灵性更新的时间。\n\n愿上帝在每个时刻都处于中心地位！🙏',
      type: 'info',
      audience: 'tous'
    }
  })
