...
import QRCodeShare from '@/frontend/components/QRCodeShare'

type Screen = 'login' | 'room' | 'app' | 'admin'
type Tab = 'annonces' | 'planning' | 'plan' | 'infos' | 'galerie' | 'share'
...
export default function HomePage() {
  ...
  const tabs: { id: Tab; icon: string; labelKey: string }[] = [
    ...
    { id: 'galerie', icon: '📸', labelKey: 'tab.galerie' },
    { id: 'plan', icon: '🗺️', labelKey: 'tab.plan' },
    { id: 'share', icon: '🔗', labelKey: 'tab.share' },
  ...
  async function registerPush() {
    try {
      ...
      const subscription = await registration.pushManager.subscribe({
        ...
        applicationServerKey: 'BP7UAtAO6MOhJNdh0FcM7c61HxhxdDb8kLkTTukp_4adzx5yjlHbhPLs2FJvTSat8fwbY7sJSEHvUGr2AwwaoM0'
      })
