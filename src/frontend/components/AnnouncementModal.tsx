...
export default function AnnouncementModal({ announcement, onClose, lang }: Props) {
  ...
  const title = lang === 'ko' ? announcement.titleKo : lang === 'zh' ? announcement.titleZh : lang === 'en' ? announcement.titleEn : announcement.titleFr
  const body = lang === 'ko' ? announcement.bodyKo : lang === 'zh' ? announcement.bodyZh : lang === 'en' ? announcement.bodyEn : announcement.bodyFr
